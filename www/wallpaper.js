...
{
    var successCallback = function() { alert("Success"); c2_callFunction('wp',['Wallpaper Set Success']) };
    var errorCallback = function() { alert("Error"); c2_callFunction('wp',['Wallpaper Set Error']) };
